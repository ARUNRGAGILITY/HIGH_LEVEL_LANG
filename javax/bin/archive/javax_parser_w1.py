...
class PseudoJavaParser:
    ...
    def _parse_template(self, lines: List[str], start_idx: int) -> Tuple[Template, int]:
        ...
        while i < len(lines):
            ...
            # End when we hit a non-indented line that's a new template or main
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  javax input.pj -o output.java
  javax input.pj --output-dir src/main/java
  javax input.pj --compile
  javax --test
        '''
    )
    ...
    try:
        ...
        # Extract program name from the pseudo code
...
program HelloWorld
    main
        print f"Hello, World!"
        print f"Check this javax"
        print f"Welcome to Pseudo Java!"
