...
def test_parser():
    ...
    # Test with different template synonyms
    test_cases = [
    ...
    for synonym, header in test_cases:
        print(f"\n{'='*50}")
        print(f"Testing with '{synonym}' keyword:")
        print(f"{'='*50}")
...
'''
        ...
        try:
            ...
            print(f"✅ Successfully parsed with '{synonym}' keyword")
    ...
    # Test mixed synonyms in one file
    print(f"\n{'='*50}")
    print("Testing mixed synonyms in comments:")
    print(f"{'='*50}")
...
// template Vehicle  (traditional way)
// design Vehicle    (architect-friendly)
// class Vehicle     (Java-like)
...
'''
    ...
    try:
        ...
        print("✅ Successfully parsed mixed synonym example")
        print("Generated Java Code:")
        print("-" * 40)
        print(java_code)
    except Exception as e:
        print(f"❌ Error with mixed synonyms: {e}")


if __name__ == "__main__":
    main()

# Experiment1: with template/blueprint/design/class 